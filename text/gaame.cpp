...
{
    if (d == 1)
    { // x1 = 40, 80, 150, 55, 120, 165; y1 = 8, 25
...
void VeHoangTu(int x, int y, int hd, int chieu)
{ // 1: sang trai, 2 sang phai
    TextColor(11);
    if (hd == 1)
    {
        gotoXY(x - 0, y - 3);
            ...
            while (1)
            {
                ...
                if (map == 1)
                {
                    if (xn == 18 && yn <= 44 && yn >= 39)
                    {
                        ...
                        else
                        {
                            TextColor(12);
                            gotoXY(80, 30);
                            cout << "Cong chua van chua duoc cuu! Hay quay tro lai cuu cong chua.";
                            getch();
                            gotoXY(80, 30);
                            cout << "                                                            ";
                            xn++;
                ...
                else
                {
                    if (xn == 18 && yn <= 25 && yn >= 20)
                    {
                        ...
                        else
                        {
                            TextColor(12);
                            gotoXY(90, 30);
                            cout << "Cong chua van chua duoc cuu!";
                            gotoXY(90, 31);
                            cout << "Hay quay tro lai cuu cong chua.";
                            getch();
                            gotoXY(90, 30);
                            cout << "                            ";
                            gotoXY(90, 31);
                ...
                if (help == 0)
                {
                    ...
                    if (time == 0)
                    {
                        TextColor(4);
                        gotoXY(80, 15);
                        cout << "The princess was murdered!";
                        getch();
                        break;
                    }
                    if (itime == 30)
