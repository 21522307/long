...
void Mung8_3(int x, int y, int color)
{
    ...
    Sleep(100);
    gotoXY(x + 0, y + 4);
    cout << " 88888888888888          //           333333333333     ";
    Sleep(100);
    gotoXY(x + 0, y + 5);
    cout << " 88          88         //                      33    ";
    Sleep(100);
...
int main()
{
    ...
    while (1)
    {
        ...
        {
            gotoXY(10, b);
            cout << "  Feel special, unique and beautiful";
            gotoXY(a, b);
            cout << "              **************                 ";
            a++;
            gotoXY(10, b);
        ...
        {
            gotoXY(10, b);
            cout << "   And today, We want to tell you that:";
            gotoXY(a, b);
            cout << "               ***********                               ";
            a++;
            gotoXY(10, b);
